...
public class ArtEntity implements DomainObject {
	...
	private Boolean isPrivilegeViewable; // can be seen by logged-in
											// non-administrators (spcial
											// visitors)
	...
	public boolean equals(Object o) {
		...
		if (description != null ? !description.equals(artEntity.description)
				: artEntity.description != null)
			return false;
		if (displayDate != null ? !displayDate.equals(artEntity.displayDate)
				: artEntity.displayDate != null)
			return false;
		if (height != null ? !height.equals(artEntity.height)
				: artEntity.height != null)
			return false;
		if (subTitle != null ? !subTitle.equals(artEntity.subTitle)
				: artEntity.subTitle != null)
			return false;
		if (title != null ? !title.equals(artEntity.title)
				: artEntity.title != null)
			return false;
		if (uploadedDate != null ? !uploadedDate.equals(artEntity.uploadedDate)
				: artEntity.uploadedDate != null)
			return false;
		if (width != null ? !width.equals(artEntity.width)
				: artEntity.width != null)
			return false;
	...
	public int hashCode() {
		...
		result = 29 * result
				+ (uploadedDate != null ? uploadedDate.hashCode() : 0);
		result = 29 * result
				+ (displayDate != null ? displayDate.hashCode() : 0);
